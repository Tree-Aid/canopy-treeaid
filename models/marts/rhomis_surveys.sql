...
coalesce(cf.proportion_of_value_controlled_female_adult::float,0.00) + coalesce(cf.proportion_of_value_controlled_female_head::float, 0.00) as proportion_of_value_controlled_female_adult,
coalesce(cf.proportion_of_value_controlled_female_youth::float, 0.00) as proportion_of_value_controlled_female_youth,
coalesce(cf.proportion_of_value_controlled_male_adult::float, 0.00) + coalesce(cf.proportion_of_value_controlled_male_head::float, 0.00) as proportion_of_value_controlled_male_adult,
coalesce(cf.proportion_of_value_controlled_male_youth::float, 0.00) as proportion_of_value_controlled_male_youth,
